...
const PortfolioItem = ({ status, tags, name, image, url }) => {
  ...
  return (
    <motion.div
      className="text-white w-full relative h-full"
      style={{
    ...
    >
      <img
        src={image}
        alt="project-image"
        className="max-w-96 w-[23rem] laptop:w-[22rem] h-full rounded-md mobile:w-full mobile:max-w-full laptop:max-w-96"
      />
